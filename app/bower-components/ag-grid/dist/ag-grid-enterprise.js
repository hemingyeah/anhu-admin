...
/***/ function(module, exports, __webpack_require__) {
	...
	var CsvCreator = (function () {
	    ...
	    CsvCreator.prototype.getDataAsCsv = function (params) {
	        ...
	        var columnsToExport;
	        /**
	         * 对导出excel模块修改,allColumns参数默认导出除序列号、和全选择列外的所有列
	         * 独孤宇云 2016-9-14
	         */
	        if (allColumns) {
	        	columnsToExport =this.columnController.getAllColumns().filter(function (obj) {
	        		return obj.colId !== "no" && obj.colId !=="checkBox";
	        	});
