//在线援助
app.controller('feedbackCtrl', ['$scope', 'gridService', 'feedbackService', 'dialog', 'toaster', '$state', 'commonApiService', '$filter',
    function($scope, gridService, feedbackService, dialog, toaster, $state, commonApiService, $filter) {
        $scope.dialog = dialog;
        $scope.query = {};
        // $scope.service = feedbackService;
        ...
        var consMethods = gridService.construtor($scope, feedbackService, $scope.gridOptions);
