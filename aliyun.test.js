...
var appServer = 'http://localhost:8088';
var bucket = 'gt-oss';
...
var client = new OSS({
    region: region,
    accessKeyId: 'XjvJRPVyIFJ054Db',
    accessKeySecret: 'zYfzVMfC0Kpi1d2tBZd5UtjNNxUXT9',
    bucket: bucket
});
//
...
var uploadFile = function(client) {
    ...
    var key = document.getElementById('object-key-file').value.trim() || file.name;
